...
module.exports = class isEnabled extends BaseComponent {
    constructor(constructorOptions) {
        super(
            constructorOptions.id,
            constructorOptions.name,
            'neutrinos_service_designer_' + 'isEnabled',

            'f412baa9-d069-e201-3526-023f8858abd7'
        );
    ...
    generateSnippet(serviceType, serviceClassTemplate) {
        ...
        `;*/
        return `
            ${this.constructorOptions.resultMapping} = this.updates.isEnabled;
        `;
    }
    ...
    updateTemplate(serviceClassTemplate) {
        ...
        const injectStr = 'private updates: SwUpdate';
