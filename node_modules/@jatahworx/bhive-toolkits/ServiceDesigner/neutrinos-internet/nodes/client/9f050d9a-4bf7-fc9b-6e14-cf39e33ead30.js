...
module.exports = class isOnline extends BaseComponent {
	constructor(constructorOptions) {
		super(
			constructorOptions.id,
			constructorOptions.name,
			'neutrinos_service_designer_' + 'isOnline',

			'9f050d9a-4bf7-fc9b-6e14-cf39e33ead30'
		);
	...
	generateSnippet(serviceType, serviceClassTemplate) {
		...
		return `
		try{
            ${this.constructorOptions.resultMapping} = window.navigator.onLine;
        } catch(e){
