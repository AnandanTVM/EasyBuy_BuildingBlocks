...
module.exports = class requestSubscription extends BaseComponent {
	constructor(constructorOptions) {
		super(
			constructorOptions.id,
			constructorOptions.name,
			'neutrinos_service_designer_' + 'requestSubscription',

			'e2d945fe-eb02-f09d-4d71-81ce05f2e103'
		);
	...
	generateSnippet(serviceType, serviceClassTemplate) {
		...
		return `
            if(this.swPush.isEnabled){
              ${this.constructorOptions.resultMapping} = await this.swPush.requestSubscription({
                    serverPublicKey: ${this.constructorOptions.serverPublicKey},
                });
            } else{
