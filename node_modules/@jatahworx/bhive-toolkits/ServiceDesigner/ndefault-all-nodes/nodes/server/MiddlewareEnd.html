<script type="text/x-red" data-template-name="MiddlewareEnd">
    ...
    registerNode({
        ...
        nodeDef: {
            ...
            defaults: {
                ...
                responseType: { value: 'next', required: true },
            ...
            inputs: 1,
            outputs: 0,
            icon: "ndefault-all-nodes/middleware-end-node.svg",
            label: function (SD) {
                return this.name || 'Middleware End';
            },
            paletteLabel: 'Middleware End',
