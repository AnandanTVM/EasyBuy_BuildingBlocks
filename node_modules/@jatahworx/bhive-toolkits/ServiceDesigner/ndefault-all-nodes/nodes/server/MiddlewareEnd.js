 ...
 * 2. Go to next() middleware
 * 3. If user wants to set data for evaluating in the
 * next middleware, he will use script node to
 * set res.data.a = 'some value';
 */
module.exports = class MiddlewareEnd extends BaseComponent {
    /**
     *Creates an instance of HttpOut.
     * @param {*} constructorOptions
     * constructorOptions.responseType: bin | obj | txt
    ...
    constructor(constructorOptions) {
        super(constructorOptions.id, constructorOptions.name, "neutrinos_service_designer_MiddlewareEnd", "MiddlewareEnd");
    ...
    init(constructorOptions) {
        this.__types = ['bin', 'obj', 'txt', 'next', 'redirect', 'stream'];
        ...
        if (this.responseType !== 'next' &&
            ...
            ((this.responseType == 'bin' && !this.responseMapping[this.responseType]) ||
